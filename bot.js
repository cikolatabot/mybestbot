...
request('https://api.collectapi.com/economy/currencyToAll?int=10&base=USD', function (error, response, body) {
  if (error) return console.log('Hata:', error);
  else if (!error) { 
      var info = JSON.parse(body);
request('https://api.collectapi.com/economy/currencyToAll?int=10&base=EUR', function (error, response, body) {
  if (error) return console.log('Hata:', error); 
  else if (!error) { 
